...
from gnpyapi.core.exception.exception_handler import register_exception_handlers
...
def path_request(
    ...
    path_request_service: PathRequestService = Depends(get_path_request_service),
):
...
import gnpyapi.core.route.status_route  # noqa: E402,F401
